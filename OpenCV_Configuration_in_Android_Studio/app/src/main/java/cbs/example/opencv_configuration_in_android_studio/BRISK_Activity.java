...
public class BRISK_Activity extends AppCompatActivity implements View.OnClickListener,View.OnLongClickListener {
        ...
        switch (v.getId()) {
            case R.id.imageView9: {
                try {
                    ...
                    Mat hana = Utils.loadResource(BRISK_Activity.this, R.drawable.hana);
                    ...
                    brisk.detect(src,matOfKeyPoint);
            ...
            case R.id.imageView10: {
                try {
                    ...
                    Mat hana = Utils.loadResource(BRISK_Activity.this, R.drawable.miho);
                    Imgproc.cvtColor(hana,src,Imgproc.COLOR_BGR2RGB);
            ...
            case R.id.imageView11: {
                try {
                    ...
                    Mat hana = Utils.loadResource(BRISK_Activity.this, R.drawable.yukari);
                    Imgproc.cvtColor(hana,src,Imgproc.COLOR_BGR2RGB);
            ...
            case R.id.imageView12: {
                try {
                    ...
                    Mat hana = Utils.loadResource(BRISK_Activity.this, R.drawable.saori);
                    Imgproc.cvtColor(hana,src,Imgproc.COLOR_BGR2RGB);
            ...
            case R.id.imageView13: {
                try {
                    ...
                    Mat hana = Utils.loadResource(BRISK_Activity.this, R.drawable.mako);
                    Imgproc.cvtColor(hana,src,Imgproc.COLOR_BGR2RGB);
        ...
        switch (v.getId()) {
            case R.id.imageView9: {
                try {
                    ...
                    resources = Utils.loadResource(BRISK_Activity.this, R.drawable.hana);
                    ...
                    brisk.detect(resources, matOfKeyPoint_box);
                    brisk.detect(src, matOfKeyPoint_scene);

                    Mat descriptor_box = new Mat();
                    Mat descriptor_scene = new Mat();

                    brisk.compute(resources, matOfKeyPoint_box, descriptor_box);
                    brisk.compute(src, matOfKeyPoint_scene, descriptor_scene);
            ...
            case R.id.imageView10: {
                try {
                    ...
                    resources = Utils.loadResource(BRISK_Activity.this, R.drawable.gup1_scale3);
                    Imgproc.cvtColor(resources,resources,Imgproc.COLOR_BGR2RGB);

                    Mat miho = Utils.loadResource(BRISK_Activity.this, R.drawable.miho);
                    Imgproc.cvtColor(miho,src,Imgproc.COLOR_BGR2RGB);

                    BRISK brisk = BRISK.create();

                    MatOfKeyPoint matOfKeyPoint_gup = new MatOfKeyPoint();//matOfKeyPoint_box
                    MatOfKeyPoint matOfKeyPoint_miho = new MatOfKeyPoint();//matOfKeyPoint_scene

                    brisk.detect(resources,matOfKeyPoint_gup);
                    brisk.detect(src,matOfKeyPoint_miho);

                    Mat descriptor_gup = new Mat();//descriptor_box
                    Mat descriptor_miho = new Mat();//descriptor_scene

                    brisk.compute(resources,matOfKeyPoint_gup,descriptor_gup);
                    brisk.compute(src,matOfKeyPoint_miho,descriptor_miho);
                    ...
                    if (src.type() == resources.type()){
                        ...
                        DescriptorMatcher descriptorMatcher = DescriptorMatcher.create(DescriptorMatcher.BRUTEFORCE_HAMMING);
                        descriptorMatcher.match(descriptor_gup,descriptor_miho,matOfDMatch);
                    }else {
                        break;
                    }
                    ...
                    Features2d.drawMatches(src, matOfKeyPoint_miho, resources, matOfKeyPoint_gup, goodMatches, outputImg, new Scalar(0,255,0), new Scalar(255,0,0), drawnMatches, Features2d.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS);

                    //Imgproc.resize(outputImg, outputImg, resources.size());
            ...
            case R.id.imageView11: {
                try {
                    ...
                    resources = Utils.loadResource(BRISK_Activity.this, R.drawable.gup1_scale2);
                    Imgproc.cvtColor(resources,resources,Imgproc.COLOR_BGR2RGB);

                    Mat yukari = Utils.loadResource(BRISK_Activity.this, R.drawable.yukari);
            ...
            case R.id.imageView12: {
                try {
                    ...
                    resources = Utils.loadResource(BRISK_Activity.this, R.drawable.gup1_scale1);
                    Imgproc.cvtColor(resources,resources,Imgproc.COLOR_BGR2RGB);

                    Mat saori = Utils.loadResource(BRISK_Activity.this, R.drawable.saori);
                    ...
                    LinkedList<DMatch> good_matches = new LinkedList<DMatch>();
                    for (int i = 0; i < matchList.size(); i++) {
                        if (matchList.get(i).distance <= (0.1 * min_dist))
                            good_matches.addLast(matchList.get(i));
                    }
            ...
            case R.id.imageView13: {
                try {
                    ...
                    resources = Utils.loadResource(BRISK_Activity.this, R.drawable.gup1);
                    Imgproc.cvtColor(resources,resources,Imgproc.COLOR_BGR2RGB);
